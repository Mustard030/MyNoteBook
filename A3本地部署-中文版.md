...
#### 配置解释器
选择全部显示
![](assets/A3本地部署-中文版/file-20260608114323830.png)

选择本地解释器
![](assets/A3本地部署-中文版/file-20260608114358428.png)

浏览，选择现有，Python路径为克隆项目章节的虚拟环境路径下的`<venv_path>/bin/python`
![](assets/A3本地部署-中文版/file-20260608114716112.png)
![](assets/A3本地部署-中文版/file-20260608114609351.png)

运行配置
![](assets/A3本地部署-中文版/file-20260608120219874.png)

将Host设置为`api.local-abp3.alvanon.com`
端口为`8001`
环境变量同上
- DJANGO_SETTINGS_MODULE=alva_platform_center.settings
- ENVIRONMENT=development
...
#### 复制项目必须文件到项目中
![](assets/A3本地部署-中文版/file-20260608122643476.png)
文件找任一后端获得

## VSCode、Cursor
安装VSCode插件：`WSL`

点击侧边栏远程资源管理器，选择Ubuntu24.04连接
![](assets/A3本地部署-中文版/file-20260608143112032.png)

打开文件夹，选择项目路径`~/alvanon-backend-3/alva_platform_center

安装插件`Python`、`Django`、`Django settings`

选择 运行和调试 → Python Debugger → Django → manage.py

此时已经创建好基本的运行脚本，需要补充以下内容
```json
// launch.json
{
...
            "args": [
                "runsslserver",
                "api.local-abp.alvanon.com:8001"  //指定Host和端口
            ],
            "django": true,
...
                "PYTHONUNBUFFERED": "1",
                "DEBUG": "True",
                "DJANGO_SETTINGS_MODULE": "alva_platform_center.settings.development",
                "ENVIRONMENT": "development"
            }
        }
    ]
...
并在.vscode文件夹中创建`settings.json`，设置解释器路径
```json
//settings.json
{
    "python.defaultInterpreterPath": "/home/harold/.local/share/virtualenvs/alvanon-backend-3-zjmrMWgJ/python"
}
```
