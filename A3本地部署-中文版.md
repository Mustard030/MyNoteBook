...
运行配置
点击修改选项，勾选自定义运行命令
![](assets/A3本地部署-中文版/file-20260713160944072.png)

自定义运行命令为：`runsslserver`
...
            "args": [
                "runsslserver",
                "api.local-abp3.alvanon.com:8001"  //指定Host和端口
            ],
            "django": true,
...
并在.vscode文件夹中创建`settings.json`，设置解释器路径，venv_path设置成你自己的
```json
//settings.json
{
...
#### 复制项目必须文件到项目中
![](assets/A3本地部署-中文版/file-20260608145143805.png)
文件找任一后端获得
